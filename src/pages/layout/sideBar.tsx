...
export function SideBar() {
	...
	return (
		<div
			...
			} bg-white text-black py-4 flex flex-col justify-between border-r border-gray-200 min-h-screen transition-all duration-300 ease-in-out max-w-[235px] will-change-[width] z-10`}
		>
