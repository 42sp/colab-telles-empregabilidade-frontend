...
const OperationFormContext = createContext<UseFormReturn<OperationFormData> | null>(null);

export const useOperationFormContext = () => {
  const ctx = useContext(OperationFormContext);
  if (!ctx) throw new Error("useOperationFormContext must be used inside a Provider");
  return ctx;
};
